import { View, Text, StyleSheet, ScrollView, ActivityIndicator, TouchableOpacity, FlatList, Modal, TextInput, Animated, TouchableWithoutFeedback } from 'react-native';
import { useLocalSearchParams, Stack, router } from 'expo-router';
import { useEffect, useState, useRef } from 'react';
import { api } from '@/lib/api';
import { LinearGradient } from 'expo-linear-gradient';
import { User, Calendar, Clock, Stethoscope, FileText, AlertCircle, ChevronLeft, Activity, Pill, Thermometer, Plus, X, FlaskConical, Radiation, Book } from 'lucide-react-native';

export default function RawatJalanDetailScreen() {
      ...
      try {
        if (no_rawat) {
          ...
          const [detailRes, tindakanRes, soapRes] = await Promise.all([
            api.rawatJalan.show(apiNoRawat),
            api.rawatJalan.showTindakan(apiNoRawat).catch(() => ({ data: {} })),
            api.rawatJalan.showSoap(apiNoRawat).catch(() => ({ data: [] }))
          ]);
    ...
    <View style={styles.container}>
      ...
      >
        <View style={styles.headerContent}>
          ...
          <Text style={styles.headerTitle}>Detail Rawat Jalan</Text>
          <View style={{ width: 24 }} />
        </View>
      </LinearGradient>
      ...
      <ScrollView contentContainerStyle={styles.content}>
        ...
        >
          ...
          <Text style={styles.registrationInfo}>
             {data.no_rawat} • {data.tgl_registrasi}
          </Text>
        </LinearGradient>
           ...
           <View style={styles.infoCard}>
             <View style={styles.infoRow}>
               <View style={styles.infoIcon}>
                 <Stethoscope color="#62B986" size={20} />
               </View>
               <View style={styles.infoContent}>
                 <Text style={styles.infoLabel}>Poliklinik</Text>
                 <Text style={styles.infoValue}>{data.nm_poli}</Text>
               </View>
             </View>
             ...
             <View style={styles.infoRow}>
               <View style={styles.infoIcon}>
                 <AlertCircle color="#62B986" size={20} />
               </View>
               <View style={styles.infoContent}>
              ...
              <View key={index} style={styles.card}>
                ...
                <View style={styles.soapRow}>
                   <View style={[styles.badge, { backgroundColor: '#E8F5E9' }]}>
                     <Text style={[styles.badgeText, { color: '#2E7D32' }]}>Suhu: {item.suhu_tubuh}°C</Text>
                   </View>
        ...
        <Animated.View style={[styles.menuContainer, { opacity: fadeAnim }]}>
          ...
          <TouchableOpacity style={styles.menuItem} onPress={() => handleAction('rad')}>
            <View style={[styles.menuIconContainer, { backgroundColor: '#FFF3E0' }]}>
              <Radiation color="#FB8C00" size={20} />
            </View>
